  ...
  return(
    <div
      ...
      <div className="w-1/3 h-auto flex flex-col items-center justify-start z-20">
        <div className={`w-[40px] sm:w-[50px] h-[40px] sm:h-[50px] bg-white border-4 border-secondary rounded-full flex items-center justify-center text-primary p-1 sm:p-2
      ...
      <div className="w-1/3 h-auto flex flex-col items-center justify-start z-20">
        <div className={`${identifier == "extras" || identifier == "payment" ? "border-secondary bg-white text-primary" : "border-slate-300 text-slate-300 bg-white" } w-[40px] sm:w-[50px] h-[40px] sm:h-[50px]  border-4 rounded-full flex items-center justify-center p-1 sm:p-2`}
      ...
      <div className="w-1/3 h-auto flex flex-col items-center justify-start z-20">
        <div className={`${identifier == "payment" ? "border-secondary bg-white text-primary" : "border-slate-300 text-slate-300 bg-white" } w-[40px] sm:w-[50px] h-[40px] sm:h-[50px]  border-4 rounded-full flex items-center justify-center p-1 sm:p-2`}
        ><CreditCard className="w-full h-full"/></div>
        <label className={`text-[10px] sm:text-xs ${identifier == "glampings" ? "text-white": "text-primary" }`}>{t("Reserve")}</label>
      </div>
    </div>
  )
