        ...
        <div className="bg-transparent fixed top-0 left-0 h-full w-full flex items-center justify-center z-10">
          ...
          <AnimatePresence>
              <motion.div
                ...
                className="relative top-0 bottom-0 left-0 right-0 bg-white lg:p-4 rounded-lg shadow-lg max-lg:w-screen lg:min-w-96 h-screen lg:h-auto lg:overflow-y-auto z-30"
              > 
